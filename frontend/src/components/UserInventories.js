...
export default function UserInventories({ userData }) {
  ...
  return (<>
    <div className="user-inventories py-5">
        ...
        <div className="tab-menu d-flex flex-md-nowrap flex-wrap justify-content-center text-light">
          {
            tabMenuItems.map((tabItem, tabItemIndex) =>
              <div key={tabItemIndex} className={`tab-item d-flex flex-md-column align-items-center p-3 p-lg-5 pb-0 pb-lg-0 mt-lg-2 mx-lg-2 ${tab === tabItemIndex ? "active" : ""}`} style={{ backgroundColor: tabItem.color }}>
      ...
      <div className="py-5 mt-4" style={{ backgroundColor: tabMenuItems[tab].color }}>
        <div className="tab-content pb-5 container" style={{ maxWidth: "800px" }}>
          <div className={`tab-pane ${tab === 0 ? "active" : ""}`}>
            <h2 className="display-6 fs-4 mb-4 text-light">Brief Central</h2>
          ...
          <div className={`tab-pane ${tab === 1 ? "active" : ""}`}>
            <h2 className="display-6 fs-4 mb-4 text-light">Presentation Central</h2>
            <div className="list-group">
          ...
          <div className={`tab-pane ${tab === 2 ? "active" : ""}`}>
            <h2 className="display-6 fs-4 mb-4 text-light">Storage Central</h2>
            <div className="list-group">
